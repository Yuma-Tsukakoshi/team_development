                        ...
                        < label for="major<?=$i?>" class="label-hover"> <?=$labels[$i-1]["label_name"] ?> < /label>
                            ...
                            < /div>
                              < div class=" contact">
                                < h2> 面談方法 < /h2>
                                    <?php for($i=3;$i<=5;$i++){ ?>
                                    < input type="checkbox" id="contact<?=$i?>" class="check-label"
                                      value="<?=$labels[$i-1]["label_name"] ?>">
                                      < label for="contact<?=$i?>" class="label-hover">
                                        <?= $labels[$i-1]["label_name"] ?> < /label>
                                          <?php }?>
                                          < /div>
                                            < div class="area">
                                              < h2> エリア < /h2>
                                                  <?php for($i=6;$i<=9;$i++){ ?>
                                                  < input type="checkbox" id="area<?=$i?>" class="check-label"
                                                    value="<?=$labels[$i-1]["label_name"] ?>">
                                                    < label for="area<?=$i?>" class="label-hover">
                                                      <?= $labels[$i-1]["label_name"] ?> < /label>
                                                        <?php }?>
                                                        < /div>
