...
<body>
  <header id="js-header" class="l-header p-header">
    <div class="p-header__logo"><img src="./user/assets/img/logo.svg" alt="POSSE"></div>
    ...
    <section class="p-top-hero">
      <div class="p-top-hero__inner">
        <div class="p-top-hero__body">
          ...
          <h1 class="text-orange-500">TEST</h1>
        </div>
        <picture class=" p-top-hero__image">
          <img src="./user/assets/img/img-hero.jpg" alt="">
        </picture>
        ...
        <div class="l-container">
          ...
          <div class="p-top-about__body">
            <picture class="p-top-about__image">
              <img src="./user/assets/img/img-about.jpg" alt="POSSEメンバー集合写真">
            </picture>
    ...
    <div class="l-footer__inner">
      <div class="p-footer__siteinfo">
        <span class="p-footer__logo">
          <img src="./user/assets/img/logo.svg" alt="POSSE">
        </span>
