...
$pdo = Database::get();
$sql = "SELECT * FROM users INNER JOIN user_register_client AS relation ON users.id = relation.user_id WHERE valid = 1 AND relation.client_id = :id ORDER BY updated_at DESC";
